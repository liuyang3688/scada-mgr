...
<head>
    ...
    <link href="/css/extend.core.css" rel="stylesheet">
</head>
                        ...
                        <section class="login_content">
                            <form action="/passport/signin" method="POST" id="login-form">
                                ...
                                <div class="separator">
                                    <div class="clearfix"></div>
                                    <div>
                                        <h1><i class="fa fa-coffee"></i>供热管理系统</h1>
                                        <p>Copyright © 2018 <a href=" ">leotech</a>. All Rights Reserved. </p>
                                    </div>
                                </div>
                            </form>
                        </section>
...
<script src="/js/extend.tool.js" type="text/javascript"></script>
<script>
    $("#modal").modal('show');
